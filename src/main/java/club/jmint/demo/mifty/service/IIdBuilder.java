...
public interface IIdBuilder {
	public int getIds(int type);
	
	public int generateOrderIdx();
	
	public int generateProductIdx();
	
	public int generateReviewIdx();
	
	public int generateSponsorIdx();
	
	public int generateUserIdx();
